...
distrib("MetaTweetClient/bin/<PLATFORM>/<CONFIG>/MetaTweetClient.exe")
distribIf("Debug", "MetaTweetClient/bin/<PLATFORM>/<CONFIG>/MetaTweetClient.pdb")
distribAs("MetaTweetClient/Properties/App.config", "MetaTweetClient.exe.config")
...
if dstDir.GetFiles("suppress_deploy").Length == 0:
    ...
    distrib("resource/configuration/SqlServerStorage-main.conf.xml")
    distrib("resource/configuration/SqlServerStorage-main.conf.default")
...
distrib("lib/System.CoreEx.dll")
distrib("lib/System.Interactive.dll")
distrib("lib/System.Reactive.dll")
...
distribIf("Release", "MetaTweetObjectModel/bin/<CONFIG>/MetaTweetObjectModel.xml")
distrib("MetaTweetServer/bin/<CONFIG>/MetaTweetServer.dll")
distribIf("Debug", "MetaTweetServer/bin/<CONFIG>/MetaTweetServer.pdb")
distribIf("Release", "MetaTweetServer/bin/<CONFIG>/MetaTweetServer.xml")
distrib("Linx/Achiral/Achiral/bin/<CONFIG>/Achiral.dll")
distribIf("Debug", "Linx/Achiral/Achiral/bin/<CONFIG>/Achiral.pdb")
...
dstDir = dstBase.CreateSubdirectory("libexec/SqlServerStorage")
distrib("SqlServerStorage/bin/<CONFIG>/SqlServerStorage.dll")
distribIf("Debug", "SqlServerStorage/bin/Debug/SqlServerStorage.pdb")

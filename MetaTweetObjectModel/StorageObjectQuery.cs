...
namespace XSpect.MetaTweet.Objects
{
        ...
        where TObject : StorageObject
    {
        ...
        public IQueryable<TObject> Evaluate(StorageObjectContext context)
        {
            return context.CreateQuery<TObject>(this.EntitySqlQuery)
                .Where(this.ScalarMatch.GetMatchExpression());
        }
    }
}
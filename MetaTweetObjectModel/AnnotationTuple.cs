...
namespace XSpect.MetaTweet.Objects
{
        ...
        : StorageObjectTuple<Annotation>
    {
        ...
        public override Expression<Func<Annotation, Boolean>> GetMatchExpression()
        {
            BinaryExpression expr = null;
            ParameterExpression param = Expression.Parameter(typeof(Annotation));
            ...
            return Expression.Lambda<Func<Annotation, Boolean>>(expr, param);
        }
    }
}
...
namespace XSpect.Reflection
{
    partial class CodeManager
    {
              ...
              IDisposable
        {
            ...
            public Domain(CodeManager parent, String key, AppDomainSetup info)
            {
                this.Parent = parent;
                this.Key = key;
            ...
            public Domain(CodeManager parent, String key, String applicationBase, IEnumerable<String> privateBinPaths)

...
namespace XSpect
{
        ...
        : Object
    {
        ...
        {
            return new Func<T2>(value2 => action(value1, value2));
        }

        public static Action<T1> Bind2nd<T1, T2>(this Action<T1, T2> action, T2 value2)
        {
            return new Func<T1>(value1 => action(value1, value2));
        }

        public static Action<T2, T3> Bind1st<T1, T2, T3>(this Action<T1, T2, T3> action, T1 value1)
        {
            return new Func<T2, T3>((value2, value3) => action(value1, value2, value3));
        }

        public static Action<T1, T3> Bind2nd<T1, T2, T3>(this Action<T1, T2, T3> action, T2 value2)
        {
            return new Func<T1, T3>((value1, value3) => action(value1, value2, value3));
        }

        public static Action<T1, T2> Bind3rd<T1, T2, T3>(this Action<T1, T2, T3> action, T3 value3)
        {
            return new Func<T1, T2>((value1, value2) => action(value1, value2, value3));
        }

        public static Action<T2, T3, T4> Bind1st<T1, T2, T3, T4>(this Action<T1, T2, T3, T4> action, T1 value1)
        {
            return new Func<T2, T3, T4>((value2, value3, value4) => action(value1, value2, value3, value4));
        }

        public static Action<T1, T3, T4> Bind2nd<T1, T2, T3, T4>(this Action<T1, T2, T3, T4> action, T2 value2)
        {
            return new Func<T1, T3, T4>((value1, value3, value4) => action(value1, value2, value3, value4));
        }

        public static Action<T1, T2, T4> Bind3rd<T1, T2, T3, T4>(this Action<T1, T2, T3, T4> action, T3 value3)
        {
            return new Func<T1, T2, T4>((value1, value2, value4) => action(value1, value2, value3, value4));
        }

        public static Action<T1, T2, T3> Bind4th<T1, T2, T3, T4>(this Action<T1, T2, T3, T4> action, T4 value4)
        {
            return new Func<T1, T2, T3>((value1, value2, value3) => action(value1, value2, value3, value4));
        }

        public static Action<T2, T3, T4, T5> Bind1st<T1, T2, T3, T4, T5>(this Action<T1, T2, T3, T4, T5> action, T1 value1)
        {
            return new Func<T2, T3, T4, T5>((value2, value3, value4, value5) => action(value1, value2, value3, value4, value5));
        }

        public static Action<T1, T3, T4, T5> Bind2nd<T1, T2, T3, T4, T5>(this Action<T1, T2, T3, T4, T5> action, T2 value2)
        {
            return new Func<T1, T3, T4, T5>((value1, value3, value4, value5) => action(value1, value2, value3, value4, value5));
        }

        public static Action<T1, T2, T4, T5> Bind3rd<T1, T2, T3, T4, T5>(this Action<T1, T2, T3, T4, T5> action, T3 value3)
        {
            return new Func<T1, T2, T4, T5>((value1, value2, value4, value5) => action(value1, value2, value3, value4, value5));
        }

        public static Action<T1, T2, T3, T5> Bind4th<T1, T2, T3, T4, T5>(this Action<T1, T2, T3, T4, T5> action, T4 value4)
        {
            return new Func<T1, T2, T3, T5>((value1, value2, value3, value5) => action(value1, value2, value3, value4, value5));
        }

        public static Action<T1, T2, T3, T4> Bind5th<T1, T2, T3, T4, T5>(this Action<T1, T2, T3, T4, T5> action, T5 value5)
        {
            return new Func<T1, T2, T3, T4>((value1, value2, value3, value4) => action(value1, value2, value3, value4, value5));
        }

        public static Action<T2, T3, T4, T5, T6> Bind1st<T1, T2, T3, T4, T5, T6>(this Action<T1, T2, T3, T4, T5, T6> action, T1 value1)
        {
            return new Func<T2, T3, T4, T5, T6>((value2, value3, value4, value5, value6) => action(value1, value2, value3, value4, value5, value6));
        }

        public static Action<T1, T3, T4, T5, T6> Bind2nd<T1, T2, T3, T4, T5, T6>(this Action<T1, T2, T3, T4, T5, T6> action, T2 value2)
        {
            return new Func<T1, T3, T4, T5, T6>((value1, value3, value4, value5, value6) => action(value1, value2, value3, value4, value5, value6));
        }

        public static Action<T1, T2, T4, T5, T6> Bind3rd<T1, T2, T3, T4, T5, T6>(this Action<T1, T2, T3, T4, T5, T6> action, T3 value3)
        {
            return new Func<T1, T2, T4, T5, T6>((value1, value2, value4, value5, value6) => action(value1, value2, value3, value4, value5, value6));
        }

        public static Action<T1, T2, T3, T5, T6> Bind4th<T1, T2, T3, T4, T5, T6>(this Action<T1, T2, T3, T4, T5, T6> action, T4 value4)
        {
            return new Func<T1, T2, T3, T5, T6>((value1, value2, value3, value5, value6) => action(value1, value2, value3, value4, value5, value6));
        }

        public static Action<T1, T2, T3, T4, T6> Bind5th<T1, T2, T3, T4, T5, T6>(this Action<T1, T2, T3, T4, T5, T6> action, T5 value5)
        {
            return new Func<T1, T2, T3, T4, T6>((value1, value2, value3, value4, value6) => action(value1, value2, value3, value4, value5, value6));
        }

        public static Action<T1, T2, T3, T4, T5> Bind6th<T1, T2, T3, T4, T5, T6>(this Action<T1, T2, T3, T4, T5, T6> action, T6 value6)
        {
            return new Func<T1, T2, T3, T4, T5>((value1, value2, value3, value4, value5) => action(value1, value2, value3, value4, value5, value6));
        }

        public static Action<T2, T3, T4, T5, T6, T7> Bind1st<T1, T2, T3, T4, T5, T6, T7>(this Action<T1, T2, T3, T4, T5, T6, T7> action, T1 value1)
        {
            return new Func<T2, T3, T4, T5, T6, T7>((value2, value3, value4, value5, value6, value7) => action(value1, value2, value3, value4, value5, value6, value7));
        }

        public static Action<T1, T3, T4, T5, T6, T7> Bind2nd<T1, T2, T3, T4, T5, T6, T7>(this Action<T1, T2, T3, T4, T5, T6, T7> action, T2 value2)
        {
            return new Func<T1, T3, T4, T5, T6, T7>((value1, value3, value4, value5, value6, value7) => action(value1, value2, value3, value4, value5, value6, value7));
        }

        public static Action<T1, T2, T4, T5, T6, T7> Bind3rd<T1, T2, T3, T4, T5, T6, T7>(this Action<T1, T2, T3, T4, T5, T6, T7> action, T3 value3)
        {
            return new Func<T1, T2, T4, T5, T6, T7>((value1, value2, value4, value5, value6, value7) => action(value1, value2, value3, value4, value5, value6, value7));
        }

        public static Action<T1, T2, T3, T5, T6, T7> Bind4th<T1, T2, T3, T4, T5, T6, T7>(this Action<T1, T2, T3, T4, T5, T6, T7> action, T4 value4)
        {
            return new Func<T1, T2, T3, T5, T6, T7>((value1, value2, value3, value5, value6, value7) => action(value1, value2, value3, value4, value5, value6, value7));
        }

        public static Action<T1, T2, T3, T4, T6, T7> Bind5th<T1, T2, T3, T4, T5, T6, T7>(this Action<T1, T2, T3, T4, T5, T6, T7> action, T5 value5)
        {
            return new Func<T1, T2, T3, T4, T6, T7>((value1, value2, value3, value4, value6, value7) => action(value1, value2, value3, value4, value5, value6, value7));
        }

        public static Action<T1, T2, T3, T4, T5, T7> Bind6th<T1, T2, T3, T4, T5, T6, T7>(this Action<T1, T2, T3, T4, T5, T6, T7> action, T6 value6)
        {
            return new Func<T1, T2, T3, T4, T5, T7>((value1, value2, value3, value4, value5, value7) => action(value1, value2, value3, value4, value5, value6, value7));
        }

        public static Action<T1, T2, T3, T4, T5, T6> Bind7th<T1, T2, T3, T4, T5, T6, T7>(this Action<T1, T2, T3, T4, T5, T6, T7> action, T7 value7)
        {
            return new Func<T1, T2, T3, T4, T5, T6>((value1, value2, value3, value4, value5, value6) => action(value1, value2, value3, value4, value5, value6, value7));
        }
        ...
        {
            return new Func<T2, T3, T4, T5, T6, T7, T8>((value2, value3, value4, value5, value6, value7, value8) => action(value1, value2, value3, value4, value5, value6, value7, value8));
        }
        ...
        {
            return new Func<T1, T3, T4, T5, T6, T7, T8>((value1, value3, value4, value5, value6, value7, value8) => action(value1, value2, value3, value4, value5, value6, value7, value8));
        }
        ...
        {
            return new Func<T1, T2, T4, T5, T6, T7, T8>((value1, value2, value4, value5, value6, value7, value8) => action(value1, value2, value3, value4, value5, value6, value7, value8));
        }
        ...
        {
            return new Func<T1, T2, T3, T5, T6, T7, T8>((value1, value2, value3, value5, value6, value7, value8) => action(value1, value2, value3, value4, value5, value6, value7, value8));
        }
        ...
        {
            return new Func<T1, T2, T3, T4, T6, T7, T8>((value1, value2, value3, value4, value6, value7, value8) => action(value1, value2, value3, value4, value5, value6, value7, value8));
        }
        ...
        {
            return new Func<T1, T2, T3, T4, T5, T7, T8>((value1, value2, value3, value4, value5, value7, value8) => action(value1, value2, value3, value4, value5, value6, value7, value8));
        }
        ...
        {
            return new Func<T1, T2, T3, T4, T5, T6, T8>((value1, value2, value3, value4, value5, value6, value8) => action(value1, value2, value3, value4, value5, value6, value7, value8));
        }
        ...
        {
            return new Func<T1, T2, T3, T4, T5, T6, T7>((value1, value2, value3, value4, value5, value6, value7) => action(value1, value2, value3, value4, value5, value6, value7, value8));
        }
    }
}